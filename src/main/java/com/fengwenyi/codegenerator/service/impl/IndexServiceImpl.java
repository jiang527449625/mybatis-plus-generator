...
import com.fengwenyi.codegenerator.generator.MyGenerator;
...
public class IndexServiceImpl implements IIndexService {
    ...
    private ResultTemplate<Void> execute(CodeGeneratorBo bo) {
        try {
            ...
            new MyGenerator(bo).myAutoGenerator(custom.getOutdir());
    ...
    private void handleDb(CodeGeneratorRequestVo requestVo, CodeGeneratorBo bo) {
        ...
        String driver = requestVo.getDriver();
...
//            driver = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
        ...
        bo.setDbType(dbType.getCode()).setDbUrl(dbUrl).setDriver(driver).setUsername(username).setPassword(password);
    }
